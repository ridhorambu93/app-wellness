                    ...
                    <div class="col-lg-4 col-md-6 mb-3">
                        <div class="card bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                            <div class="card-header bg-gray-100 dark:bg-gray-700 p-2 border-b border-gray-200 dark:border-gray-600">
                                {{-- <h5 class="text-base font-bold tracking-tight text-gray-900 dark:text-white text-capitalize">Status : {{$data->status_survey}}</h5> --}}
                                <h5 class="text-base font-bold tracking-tight text-gray-900 dark:text-white text-capitalize">Status : {{ $data->status_survey == 'aktif' ? 'aktif' : 'nonaktif' }}</h5>
                            </div>
